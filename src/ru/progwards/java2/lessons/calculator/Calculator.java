...
public class Calculator {
    ...
    public static void main(String[] args) {
        System.out.println(calculate("8/3*2+8/2-5")); //6
        System.out.println(calculate("1+3*2-9/3*9")); //0
    }
    ...
    public static double calculate(String expression) throws  NumberFormatException{
        ...
        double i = Double.valueOf(str.substring(0, 1));
        ...
        while (s.equals("*") || s.equals("/")) {
            if (s.equals("*")) {
                ...
                i *= Double.valueOf(str.substring(2, 3));
