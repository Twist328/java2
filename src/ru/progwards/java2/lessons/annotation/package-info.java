 ...
 * Содержит  класс AvlTree - АВЛ дерево, с методами:
 * 2.1 public void put(K key, V value) - с добавлением пары ключ-значение, или если уже такой ключ есть - его замена
 ...
 * 2.5 public void process(Consumer<TreeLeaf<K,V>> consumer) - прямой обход дерева
